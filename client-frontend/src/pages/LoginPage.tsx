...
const LoginPage: React.FC = () => {
  ...
  try {
    ...
    console.error('🔧 LoginPage: Auth context error:', error);
    authError = true;
  }
  
  const { login, isLoading, user } = authData || { login: async () => {}, isLoading: false, user: null };
  ...
  return (
    <div className="min-h-screen bg-[#080808] text-white">
      ...
      <main className="container mx-auto px-2 md:px-4 py-8 md:py-16 flex flex-col items-center justify-center min-h-[calc(100vh-80px)]">
        ...
        {isLoading && (
          <div className="mt-4 text-center text-[#85A8C3]">
            Logging in...
          </div>
        )}
      </main>
