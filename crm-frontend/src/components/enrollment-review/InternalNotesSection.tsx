...
const InternalNotesSection: React.FC<InternalNotesSectionProps> = ({ traderId }) => {
  const {
        ...
        <div className="space-y-4 p-4 border rounded-lg bg-muted/50">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="flex items-center space-x-2">
              <Switch id="high-risk-er" checked={isHighRisk} onCheckedChange={setIsHighRisk} />
              <Label htmlFor="high-risk-er" className="flex items-center gap-1">
